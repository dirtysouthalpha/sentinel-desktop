"""
Sentinel Desktop v25.0.0 — System Tray Icon.
...
class SystemTrayIcon:
    """System tray icon with context menu for Sentinel Desktop v25.0.0.
    ...
    def start(self) -> bool:
        ...
        self._icon = pystray.Icon(
            ...
            icon=icon_image,
            title="Sentinel Desktop v25.0.0 — Idle",
            menu=menu,
        )
    ...
    def update_status(self, status: str) -> None:
        ...
        try:
            ...
            self._icon.title = f"Sentinel Desktop v25.0.0 — {label}"
