...
class ScriptsTab:
    ...
    def _build_left_panel(self) -> None:
        left = ctk.CTkFrame(self.frame, fg_color=self._t("bg_secondary", "#161b22"),
                            corner_radius=10)
        ...
        ctk.CTkEntry(
            ...
            border_color=self._t("bg_hover", "#30363d"),
        ...
        for cat in _CATEGORIES:
            btn = ctk.CTkButton(
                ...
                corner_radius=13, command=lambda c=cat: self._set_category(c))
    ...
    def _build_right_panel(self) -> None:
        right = ctk.CTkFrame(self.frame, fg_color=self._t("bg_secondary", "#161b22"),
                             corner_radius=10)
        ...
        self._name_label = ctk.CTkLabel(
            ...
            text_color=self._t("text_primary", "#c9d1d9"), anchor="w")
        ...
        self._meta_label = ctk.CTkLabel(
            ...
            text_color=self._t("text_secondary", "#8b949e"), anchor="w")
        ...
        self._run_btn = ctk.CTkButton(
            ...
            hover_color=self._t("accent_hover", "#79b8ff"),
        ...
        ctk.CTkButton(
            ...
            hover_color=self._t("bg_hover", "#30363d"),
            text_color=self._t("text_primary", "#c9d1d9"),
            corner_radius=8, command=self._open_recorder).pack(side="left")
        ...
        self._output_box = ctk.CTkTextbox(
            ...
            fg_color=self._t("bg_input", "#21262d"),
            text_color=self._t("text_primary", "#c9d1d9"), corner_radius=8)
    ...
    def _highlight_chip(self, active_idx: int) -> None:
        for i, btn in enumerate(self._chip_btns):
            if i == active_idx:
                btn.configure(fg_color=self._t("accent", "#58a6ff"), text_color="#ffffff")
            else:
                btn.configure(fg_color=self._t("bg_input", "#21262d"),
                              text_color=self._t("text_secondary", "#8b949e"))
